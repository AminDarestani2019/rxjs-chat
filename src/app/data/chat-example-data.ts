...
const me: User      = new User('Juliet', 'images/avatars/female-avatar-1.png');
const ladycap: User = new User('Lady Capulet', 'images/avatars/female-avatar-2.png');
const echo: User    = new User('Echo Bot', 'images/avatars/male-avatar-1.png');
const rev: User     = new User('Reverse Bot', 'images/avatars/female-avatar-4.png');
const wait: User    = new User('Waiting Bot', 'images/avatars/male-avatar-2.png');
